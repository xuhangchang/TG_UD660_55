...
* param2:     	char sound_cmd	: sound cmd (input)
* return:    	void 			            -   
* other:
*		0x00	Bi
*		0x01	BiBi	
...
* param1: 		int fd			: gpio fd (input)
* param2:     	char model		: 0,open; 1,close; (input)
* param3:     	int duty_pct	: pwm percent % (input)
* return:    	void 			            -   
* others£º
*
* date:       	2017/03/04			
...
* param1: 		int fd			: gpio fd (input)
* param2:     	int flag		: model  1:register model
*								     	 2:compare model
...
*										   
*
* other:	register model : if touch,return 1;
